  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <Button
        ...
        className="relative flex items-center gap-2 bg-white hover:bg-gray-50 text-gray-700 px-4 py-2 rounded-lg transition font-semibold shadow-md hover:shadow-lg border border-gray-200"
      >
        <Bell size={20} />
