...
export const criarEquipe = async (req, res) => {
    try {
        ...
        // verifica se o coordenador existe e se ele já pertence a alguma equipe
        ...
        res.status(201).json({ 
            ...
            equipe: { ...equipeSalva.toObject(), pontos_acumulados: equipeGincanaSalva.pontos_acumulados }
        });
